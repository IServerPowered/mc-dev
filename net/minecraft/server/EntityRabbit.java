...
public class EntityRabbit extends EntityAnimal {
    ...
    public EntityRabbit(World world) {
        ...
        this.bt = null;
        this.a(0.6F, 0.7F);
        this.effects = new ControllerJumpRabbit(this, this);
    ...
    public void E() {
        ...
        if (this.onGround) {
            ...
            ControllerJumpRabbit controllerjumprabbit = (ControllerJumpRabbit) this.effects;
    ...
    private void cr() {
        ((ControllerJumpRabbit) this.effects).a(true);
    }

    private void cs() {
        ((ControllerJumpRabbit) this.effects).a(false);
    }
