...
public class Block {
    ...
    public static final Block.b e = new Block.b("stone", 1.0F, 1.0F);
    public static final Block.b f = new Block.b("wood", 1.0F, 1.0F);
    public static final Block.b g = new Block.b("gravel", 1.0F, 1.0F);
    public static final Block.b h = new Block.b("grass", 1.0F, 1.0F);
    public static final Block.b i = new Block.b("stone", 1.0F, 1.0F);
    public static final Block.b j = new Block.b("stone", 1.0F, 1.5F);
    public static final Block.b k = new Block.b("stone", 1.0F, 1.0F) {
    ...
    public static final Block.b l = new Block.b("cloth", 1.0F, 1.0F);
    public static final Block.b m = new Block.b("sand", 1.0F, 1.0F);
    public static final Block.b n = new Block.b("snow", 1.0F, 1.0F);
    public static final Block.b o = new Block.b("ladder", 1.0F, 1.0F) {
        public String getBreakSound() {
            return "dig.wood";
        }
    };
    public static final Block.b p = new Block.b("anvil", 0.3F, 1.0F) {
        public String getBreakSound() {
            return "dig.stone";
        }
    ...
    public static final Block.b q = new Block.b("slime", 1.0F, 1.0F) {
        public String getBreakSound() {
    ...
    protected Block a(Block.b block_b) {
        this.stepSound = block_b;
        return this;
    }
    ...
    public static void S() {
        ...
        a(53, "oak_stairs", (new BlockStairs(block1.getBlockData().set(BlockWood.VARIANT, BlockWood.a.OAK))).c("stairsWood"));
        ...
        a(70, "stone_pressure_plate", (new BlockPressurePlateBinary(Material.STONE, BlockPressurePlateBinary.a.MOBS)).c(0.5F).a(Block.i).c("pressurePlateStone"));
        a(71, "iron_door", (new BlockDoor(Material.ORE)).c(5.0F).a(Block.j).c("doorIron").K());
        a(72, "wooden_pressure_plate", (new BlockPressurePlateBinary(Material.WOOD, BlockPressurePlateBinary.a.EVERYTHING)).c(0.5F).a(Block.f).c("pressurePlateWood"));
        ...
        a(85, "fence", (new BlockFence(Material.WOOD, BlockWood.a.OAK.c())).c(2.0F).b(5.0F).a(Block.f).c("fence"));
        ...
        a(107, "fence_gate", (new BlockFenceGate(BlockWood.a.OAK)).c(2.0F).b(5.0F).a(Block.f).c("fenceGate"));
        a(108, "brick_stairs", (new BlockStairs(block5.getBlockData())).c("stairsBrick"));
        a(109, "stone_brick_stairs", (new BlockStairs(block8.getBlockData().set(BlockSmoothBrick.VARIANT, BlockSmoothBrick.a.DEFAULT))).c("stairsStoneBrickSmooth"));
        ...
        a(128, "sandstone_stairs", (new BlockStairs(block2.getBlockData().set(BlockSandStone.TYPE, BlockSandStone.a.SMOOTH))).c("stairsSandStone"));
        ...
        a(134, "spruce_stairs", (new BlockStairs(block1.getBlockData().set(BlockWood.VARIANT, BlockWood.a.SPRUCE))).c("stairsWoodSpruce"));
        a(135, "birch_stairs", (new BlockStairs(block1.getBlockData().set(BlockWood.VARIANT, BlockWood.a.BIRCH))).c("stairsWoodBirch"));
        a(136, "jungle_stairs", (new BlockStairs(block1.getBlockData().set(BlockWood.VARIANT, BlockWood.a.JUNGLE))).c("stairsWoodJungle"));
        ...
        a(156, "quartz_stairs", (new BlockStairs(block11.getBlockData().set(BlockQuartz.VARIANT, BlockQuartz.a.DEFAULT))).c("stairsQuartz"));
        ...
        a(163, "acacia_stairs", (new BlockStairs(block1.getBlockData().set(BlockWood.VARIANT, BlockWood.a.ACACIA))).c("stairsWoodAcacia"));
        a(164, "dark_oak_stairs", (new BlockStairs(block1.getBlockData().set(BlockWood.VARIANT, BlockWood.a.DARK_OAK))).c("stairsWoodDarkOak"));
        ...
        a(176, "standing_banner", (new BlockBanner.a()).c(1.0F).a(Block.f).c("banner").K());
        a(177, "wall_banner", (new BlockBanner.b()).c(1.0F).a(Block.f).c("banner").K());
        ...
        a(180, "red_sandstone_stairs", (new BlockStairs(block12.getBlockData().set(BlockRedSandstone.TYPE, BlockRedSandstone.a.SMOOTH))).c("stairsRedSandStone"));
        ...
        a(183, "spruce_fence_gate", (new BlockFenceGate(BlockWood.a.SPRUCE)).c(2.0F).b(5.0F).a(Block.f).c("spruceFenceGate"));
        a(184, "birch_fence_gate", (new BlockFenceGate(BlockWood.a.BIRCH)).c(2.0F).b(5.0F).a(Block.f).c("birchFenceGate"));
        a(185, "jungle_fence_gate", (new BlockFenceGate(BlockWood.a.JUNGLE)).c(2.0F).b(5.0F).a(Block.f).c("jungleFenceGate"));
        a(186, "dark_oak_fence_gate", (new BlockFenceGate(BlockWood.a.DARK_OAK)).c(2.0F).b(5.0F).a(Block.f).c("darkOakFenceGate"));
        a(187, "acacia_fence_gate", (new BlockFenceGate(BlockWood.a.ACACIA)).c(2.0F).b(5.0F).a(Block.f).c("acaciaFenceGate"));
        a(188, "spruce_fence", (new BlockFence(Material.WOOD, BlockWood.a.SPRUCE.c())).c(2.0F).b(5.0F).a(Block.f).c("spruceFence"));
        a(189, "birch_fence", (new BlockFence(Material.WOOD, BlockWood.a.BIRCH.c())).c(2.0F).b(5.0F).a(Block.f).c("birchFence"));
        a(190, "jungle_fence", (new BlockFence(Material.WOOD, BlockWood.a.JUNGLE.c())).c(2.0F).b(5.0F).a(Block.f).c("jungleFence"));
        a(191, "dark_oak_fence", (new BlockFence(Material.WOOD, BlockWood.a.DARK_OAK.c())).c(2.0F).b(5.0F).a(Block.f).c("darkOakFence"));
        a(192, "acacia_fence", (new BlockFence(Material.WOOD, BlockWood.a.ACACIA.c())).c(2.0F).b(5.0F).a(Block.f).c("acaciaFence"));
    ...
    public static class b {
        ...
        public b(String s, float f, float f1) {
            this.a = s;
            this.b = f;
            this.c = f1;
        }
