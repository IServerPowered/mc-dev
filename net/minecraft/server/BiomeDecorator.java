...
public class BiomeDecorator {
    ...
    public BiomeDecorator() {
        ...
        this.s = new WorldGenFlowers(Blocks.YELLOW_FLOWER, BlockFlowers.a.DANDELION);
    ...
    public void a(World world, Random random, BiomeBase biomebase, BlockPosition blockposition) {
        if (this.a != null) {
            ...
            if (s != null) {
                this.d = CustomWorldSettingsFinal.a.a(s).b();
            } else {
                this.d = CustomWorldSettingsFinal.a.a("").b();
            }
            ...
            this.j = new WorldGenMinable(Blocks.STONE.getBlockData().set(BlockStone.VARIANT, BlockStone.a.GRANITE), this.d.Q);
            this.k = new WorldGenMinable(Blocks.STONE.getBlockData().set(BlockStone.VARIANT, BlockStone.a.DIORITE), this.d.U);
            this.l = new WorldGenMinable(Blocks.STONE.getBlockData().set(BlockStone.VARIANT, BlockStone.a.ANDESITE), this.d.Y);
    ...
    protected void a(BiomeBase biomebase) {
        ...
        for (j = 0; j < this.B; ++j) {
            ...
            if (i1 > 0) {
                ...
                BlockFlowers.a blockflowers_a = biomebase.a(this.b, blockposition1);
                BlockFlowers blockflowers = blockflowers_a.a().a();

                if (blockflowers.getMaterial() != Material.AIR) {
                    this.s.a(blockflowers, blockflowers_a);
