...
public class BlockStairs extends Block {
    ...
    public static final BlockStateEnum<BlockStairs.a> HALF = BlockStateEnum.of("half", BlockStairs.a.class);
    public static final BlockStateEnum<BlockStairs.b> SHAPE = BlockStateEnum.of("shape", BlockStairs.b.class);
    ...
    protected BlockStairs(IBlockData iblockdata) {
        ...
        this.j(this.blockStateList.getBlockData().set(BlockStairs.FACING, EnumDirection.NORTH).set(BlockStairs.HALF, BlockStairs.a.BOTTOM).set(BlockStairs.SHAPE, BlockStairs.b.STRAIGHT));
    ...
    public void e(IBlockAccess iblockaccess, BlockPosition blockposition) {
        if (iblockaccess.getType(blockposition).get(BlockStairs.HALF) == BlockStairs.a.TOP) {
    ...
    public int f(IBlockAccess iblockaccess, BlockPosition blockposition) {
        ...
        BlockStairs.a blockstairs_a = (BlockStairs.a) iblockdata.get(BlockStairs.HALF);
        boolean flag = blockstairs_a == BlockStairs.a.TOP;
        ...
        if (enumdirection == EnumDirection.EAST) {
            ...
            if (c(block) && blockstairs_a == iblockdata1.get(BlockStairs.HALF)) {
    ...
    public IBlockData getPlacedState(World world, BlockPosition blockposition, EnumDirection enumdirection, float f, float f1, float f2, int i, EntityLiving entityliving) {
        ...
        iblockdata = iblockdata.set(BlockStairs.FACING, entityliving.getDirection()).set(BlockStairs.SHAPE, BlockStairs.b.STRAIGHT);
        return enumdirection != EnumDirection.DOWN && (enumdirection == EnumDirection.UP || (double) f1 <= 0.5D) ? iblockdata.set(BlockStairs.HALF, BlockStairs.a.BOTTOM) : iblockdata.set(BlockStairs.HALF, BlockStairs.a.TOP);
    }
    ...
    public MovingObjectPosition a(World world, BlockPosition blockposition, Vec3D vec3d, Vec3D vec3d1) {
        ...
        boolean flag = iblockdata.get(BlockStairs.HALF) == BlockStairs.a.TOP;
    ...
    public IBlockData fromLegacyData(int i) {
        IBlockData iblockdata = this.getBlockData().set(BlockStairs.HALF, (i & 4) > 0 ? BlockStairs.a.TOP : BlockStairs.a.BOTTOM);
    ...
    public int toLegacyData(IBlockData iblockdata) {
        ...
        if (iblockdata.get(BlockStairs.HALF) == BlockStairs.a.TOP) {
            i |= 4;
        }
    ...
    public IBlockData updateState(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition) {
        if (this.h(iblockaccess, blockposition)) {
            ...
            case 0:
                iblockdata = iblockdata.set(BlockStairs.SHAPE, BlockStairs.b.STRAIGHT);
                break;

            case 1:
                iblockdata = iblockdata.set(BlockStairs.SHAPE, BlockStairs.b.INNER_RIGHT);
                break;

            case 2:
                iblockdata = iblockdata.set(BlockStairs.SHAPE, BlockStairs.b.INNER_LEFT);
            }
        } else {
            ...
            case 1:
                iblockdata = iblockdata.set(BlockStairs.SHAPE, BlockStairs.b.OUTER_RIGHT);
                break;

            case 2:
                iblockdata = iblockdata.set(BlockStairs.SHAPE, BlockStairs.b.OUTER_LEFT);
            }
        }
