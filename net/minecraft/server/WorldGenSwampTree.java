...
public class WorldGenSwampTree extends WorldGenTreeAbstract {
    ...
    private static final IBlockData b = Blocks.LEAVES.getBlockData().set(BlockLeaves1.VARIANT, BlockWood.a.OAK).set(BlockLeaves1.CHECK_DECAY, Boolean.valueOf(false));
