...
public class BlockPumpkin extends BlockDirectional {
    ...
    private void f(World world, BlockPosition blockposition) {
        ShapeDetector.b shapedetector_b;
        int i;
        int j;

        if ((shapedetector_b = this.getDetectorSnowGolem().a(world, blockposition)) != null) {
            for (i = 0; i < this.getDetectorSnowGolem().b(); ++i) {
                ShapeDetectorBlock shapedetectorblock = shapedetector_b.a(0, i, 0);

                world.setTypeAndData(shapedetectorblock.d(), Blocks.AIR.getBlockData(), 2);
            }

            EntitySnowman entitysnowman = new EntitySnowman(world);
            BlockPosition blockposition1 = shapedetector_b.a(0, 2, 0).d();
            ...
            for (j = 0; j < this.getDetectorSnowGolem().b(); ++j) {
                ShapeDetectorBlock shapedetectorblock1 = shapedetector_b.a(0, j, 0);

                world.update(shapedetectorblock1.d(), Blocks.AIR);
            }
        } else if ((shapedetector_b = this.getDetectorIronGolem().a(world, blockposition)) != null) {
            for (i = 0; i < this.getDetectorIronGolem().c(); ++i) {
                for (int k = 0; k < this.getDetectorIronGolem().b(); ++k) {
                    world.setTypeAndData(shapedetector_b.a(i, k, 0).d(), Blocks.AIR.getBlockData(), 2);
                }
            }
            ...
            for (j = 0; j < this.getDetectorIronGolem().c(); ++j) {
                for (int l = 0; l < this.getDetectorIronGolem().b(); ++l) {
                    ShapeDetectorBlock shapedetectorblock2 = shapedetector_b.a(j, l, 0);
