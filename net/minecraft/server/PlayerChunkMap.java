...
public class PlayerChunkMap {
    ...
    public void b(EntityPlayer entityplayer) {
        ArrayList arraylist = Lists.newArrayList((Iterable) entityplayer.chunkCoordIntPairQueue);
        int i = 0;
        int j = this.g;
    ...
    public void a(int i) {
        ...
        if (i != this.g) {
            int j = i - this.g;
            ArrayList arraylist = Lists.newArrayList((Iterable) this.managedPlayers);
