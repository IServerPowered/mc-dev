...
public class WorldGenVillage extends StructureGenerator {
    ...
    protected StructureStart b(int i, int j) {
        return new WorldGenVillage.a(this.c, this.b, i, j, this.f);
    }
    ...
    public static class a extends StructureStart {
        ...
        public a(World world, Random random, int i, int j, int k) {
            super(i, j);
            List list = WorldGenVillagePieces.a(random, k);
            WorldGenVillagePieces.k worldgenvillagepieces_k = new WorldGenVillagePieces.k(world.getWorldChunkManager(), 0, random, (i << 4) + 2, (j << 4) + 2, list, k);

            this.a.add(worldgenvillagepieces_k);
            worldgenvillagepieces_k.a((StructurePiece) worldgenvillagepieces_k, (List) this.a, random);
            List list1 = worldgenvillagepieces_k.g;
            List list2 = worldgenvillagepieces_k.f;
            ...
            while (!list1.isEmpty() || !list2.isEmpty()) {
                ...
                if (list1.isEmpty()) {
                    ...
                    structurepiece.a((StructurePiece) worldgenvillagepieces_k, (List) this.a, random);
                } else {
            ...
            while (iterator.hasNext()) {
                ...
                if (!(structurepiece1 instanceof WorldGenVillagePieces.o)) {
                    ++l;
                }
            }
