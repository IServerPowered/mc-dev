...
public class BlockPiston extends Block {
    ...
    public boolean a(World world, BlockPosition blockposition, IBlockData iblockdata, int i, int j) {
        ...
        if (i == 0) {
            ...
            world.setTypeAndData(blockposition, Blocks.PISTON_EXTENSION.getBlockData().set(BlockPistonMoving.FACING, enumdirection).set(BlockPistonMoving.TYPE, this.N ? BlockPistonExtension.a.STICKY : BlockPistonExtension.a.DEFAULT), 3);
    ...
    private boolean a(World world, BlockPosition blockposition, EnumDirection enumdirection, boolean flag) {
        ...
        if (!pistonextendschecker.a()) {
            ...
            if (flag) {
                BlockPistonExtension.a blockpistonextension_a = this.N ? BlockPistonExtension.a.STICKY : BlockPistonExtension.a.DEFAULT;

                iblockdata = Blocks.PISTON_HEAD.getBlockData().set(BlockPistonExtension.FACING, enumdirection).set(BlockPistonExtension.TYPE, blockpistonextension_a);
                IBlockData iblockdata1 = Blocks.PISTON_EXTENSION.getBlockData().set(BlockPistonMoving.FACING, enumdirection).set(BlockPistonMoving.TYPE, this.N ? BlockPistonExtension.a.STICKY : BlockPistonExtension.a.DEFAULT);
