...
public class Item {
    ...
    public static void t() {
        a(Blocks.STONE, (Item) (new ItemMultiTexture(Blocks.STONE, Blocks.STONE, new Function() {
            public String a(ItemStack itemstack) {
                return BlockStone.a.a(itemstack.getData()).d();
            }
        ...
        a(Blocks.DIRT, (Item) (new ItemMultiTexture(Blocks.DIRT, Blocks.DIRT, new Function() {
            public String a(ItemStack itemstack) {
                return BlockDirt.a.a(itemstack.getData()).c();
            }
        ...
        a(Blocks.PLANKS, (Item) (new ItemMultiTexture(Blocks.PLANKS, Blocks.PLANKS, new Function() {
            public String a(ItemStack itemstack) {
                return BlockWood.a.a(itemstack.getData()).d();
            }
        ...
        a((Block) Blocks.SAND, (Item) (new ItemMultiTexture(Blocks.SAND, Blocks.SAND, new Function() {
            public String a(ItemStack itemstack) {
                return BlockSand.a.a(itemstack.getData()).d();
            }
        ...
        a(Blocks.LOG2, (Item) (new ItemMultiTexture(Blocks.LOG2, Blocks.LOG2, new Function() {
            public String a(ItemStack itemstack) {
                return BlockWood.a.a(itemstack.getData() + 4).d();
            }
        ...
        a(Blocks.SANDSTONE, (Item) (new ItemMultiTexture(Blocks.SANDSTONE, Blocks.SANDSTONE, new Function() {
            public String a(ItemStack itemstack) {
                return BlockSandStone.a.a(itemstack.getData()).c();
            }
        ...
        a((Block) Blocks.YELLOW_FLOWER, (Item) (new ItemMultiTexture(Blocks.YELLOW_FLOWER, Blocks.YELLOW_FLOWER, new Function() {
            public String a(ItemStack itemstack) {
                return BlockFlowers.a.a(BlockFlowers.b.YELLOW, itemstack.getData()).d();
            }
        ...
        a((Block) Blocks.RED_FLOWER, (Item) (new ItemMultiTexture(Blocks.RED_FLOWER, Blocks.RED_FLOWER, new Function() {
            public String a(ItemStack itemstack) {
                return BlockFlowers.a.a(BlockFlowers.b.RED, itemstack.getData()).d();
            }
        ...
        a(Blocks.MONSTER_EGG, (Item) (new ItemMultiTexture(Blocks.MONSTER_EGG, Blocks.MONSTER_EGG, new Function() {
            public String a(ItemStack itemstack) {
                return BlockMonsterEggs.a.a(itemstack.getData()).c();
            }
        ...
        a(Blocks.STONEBRICK, (Item) (new ItemMultiTexture(Blocks.STONEBRICK, Blocks.STONEBRICK, new Function() {
            public String a(ItemStack itemstack) {
                return BlockSmoothBrick.a.a(itemstack.getData()).c();
            }
        ...
        a(Blocks.COBBLESTONE_WALL, (Item) (new ItemMultiTexture(Blocks.COBBLESTONE_WALL, Blocks.COBBLESTONE_WALL, new Function() {
            public String a(ItemStack itemstack) {
                return BlockCobbleWall.a.a(itemstack.getData()).c();
            }
        ...
        a((Block) Blocks.DOUBLE_PLANT, (Item) (new ItemTallPlant(Blocks.DOUBLE_PLANT, Blocks.DOUBLE_PLANT, new Function() {
            public String a(ItemStack itemstack) {
                return BlockTallPlant.b.a(itemstack.getData()).c();
            }
        ...
        a(Blocks.PRISMARINE, (Item) (new ItemMultiTexture(Blocks.PRISMARINE, Blocks.PRISMARINE, new Function() {
            public String a(ItemStack itemstack) {
                return BlockPrismarine.a.a(itemstack.getData()).c();
            }
        ...
        a(Blocks.RED_SANDSTONE, (Item) (new ItemMultiTexture(Blocks.RED_SANDSTONE, Blocks.RED_SANDSTONE, new Function() {
            public String a(ItemStack itemstack) {
                return BlockRedSandstone.a.a(itemstack.getData()).c();
            }
        ...
        a(256, "iron_shovel", (new ItemSpade(Item.a.IRON)).c("shovelIron"));
        a(257, "iron_pickaxe", (new ItemPickaxe(Item.a.IRON)).c("pickaxeIron"));
        a(258, "iron_axe", (new ItemAxe(Item.a.IRON)).c("hatchetIron"));
        ...
        a(267, "iron_sword", (new ItemSword(Item.a.IRON)).c("swordIron"));
        a(268, "wooden_sword", (new ItemSword(Item.a.WOOD)).c("swordWood"));
        a(269, "wooden_shovel", (new ItemSpade(Item.a.WOOD)).c("shovelWood"));
        a(270, "wooden_pickaxe", (new ItemPickaxe(Item.a.WOOD)).c("pickaxeWood"));
        a(271, "wooden_axe", (new ItemAxe(Item.a.WOOD)).c("hatchetWood"));
        a(272, "stone_sword", (new ItemSword(Item.a.STONE)).c("swordStone"));
        a(273, "stone_shovel", (new ItemSpade(Item.a.STONE)).c("shovelStone"));
        a(274, "stone_pickaxe", (new ItemPickaxe(Item.a.STONE)).c("pickaxeStone"));
        a(275, "stone_axe", (new ItemAxe(Item.a.STONE)).c("hatchetStone"));
        a(276, "diamond_sword", (new ItemSword(Item.a.EMERALD)).c("swordDiamond"));
        a(277, "diamond_shovel", (new ItemSpade(Item.a.EMERALD)).c("shovelDiamond"));
        a(278, "diamond_pickaxe", (new ItemPickaxe(Item.a.EMERALD)).c("pickaxeDiamond"));
        a(279, "diamond_axe", (new ItemAxe(Item.a.EMERALD)).c("hatchetDiamond"));
        ...
        a(283, "golden_sword", (new ItemSword(Item.a.GOLD)).c("swordGold"));
        a(284, "golden_shovel", (new ItemSpade(Item.a.GOLD)).c("shovelGold"));
        a(285, "golden_pickaxe", (new ItemPickaxe(Item.a.GOLD)).c("pickaxeGold"));
        a(286, "golden_axe", (new ItemAxe(Item.a.GOLD)).c("hatchetGold"));
        ...
        a(290, "wooden_hoe", (new ItemHoe(Item.a.WOOD)).c("hoeWood"));
        a(291, "stone_hoe", (new ItemHoe(Item.a.STONE)).c("hoeStone"));
        a(292, "iron_hoe", (new ItemHoe(Item.a.IRON)).c("hoeIron"));
        a(293, "diamond_hoe", (new ItemHoe(Item.a.EMERALD)).c("hoeDiamond"));
        a(294, "golden_hoe", (new ItemHoe(Item.a.GOLD)).c("hoeGold"));
        ...
        a(298, "leather_helmet", (new ItemArmor(ItemArmor.a.LEATHER, 0, 0)).c("helmetCloth"));
        a(299, "leather_chestplate", (new ItemArmor(ItemArmor.a.LEATHER, 0, 1)).c("chestplateCloth"));
        a(300, "leather_leggings", (new ItemArmor(ItemArmor.a.LEATHER, 0, 2)).c("leggingsCloth"));
        a(301, "leather_boots", (new ItemArmor(ItemArmor.a.LEATHER, 0, 3)).c("bootsCloth"));
        a(302, "chainmail_helmet", (new ItemArmor(ItemArmor.a.CHAIN, 1, 0)).c("helmetChain"));
        a(303, "chainmail_chestplate", (new ItemArmor(ItemArmor.a.CHAIN, 1, 1)).c("chestplateChain"));
        a(304, "chainmail_leggings", (new ItemArmor(ItemArmor.a.CHAIN, 1, 2)).c("leggingsChain"));
        a(305, "chainmail_boots", (new ItemArmor(ItemArmor.a.CHAIN, 1, 3)).c("bootsChain"));
        a(306, "iron_helmet", (new ItemArmor(ItemArmor.a.IRON, 2, 0)).c("helmetIron"));
        a(307, "iron_chestplate", (new ItemArmor(ItemArmor.a.IRON, 2, 1)).c("chestplateIron"));
        a(308, "iron_leggings", (new ItemArmor(ItemArmor.a.IRON, 2, 2)).c("leggingsIron"));
        a(309, "iron_boots", (new ItemArmor(ItemArmor.a.IRON, 2, 3)).c("bootsIron"));
        a(310, "diamond_helmet", (new ItemArmor(ItemArmor.a.DIAMOND, 3, 0)).c("helmetDiamond"));
        a(311, "diamond_chestplate", (new ItemArmor(ItemArmor.a.DIAMOND, 3, 1)).c("chestplateDiamond"));
        a(312, "diamond_leggings", (new ItemArmor(ItemArmor.a.DIAMOND, 3, 2)).c("leggingsDiamond"));
        a(313, "diamond_boots", (new ItemArmor(ItemArmor.a.DIAMOND, 3, 3)).c("bootsDiamond"));
        a(314, "golden_helmet", (new ItemArmor(ItemArmor.a.GOLD, 4, 0)).c("helmetGold"));
        a(315, "golden_chestplate", (new ItemArmor(ItemArmor.a.GOLD, 4, 1)).c("chestplateGold"));
        a(316, "golden_leggings", (new ItemArmor(ItemArmor.a.GOLD, 4, 2)).c("leggingsGold"));
        a(317, "golden_boots", (new ItemArmor(ItemArmor.a.GOLD, 4, 3)).c("bootsGold"));
        ...
        a(328, "minecart", (new ItemMinecart(EntityMinecartAbstract.a.RIDEABLE)).c("minecart"));
        ...
        a(342, "chest_minecart", (new ItemMinecart(EntityMinecartAbstract.a.CHEST)).c("minecartChest"));
        a(343, "furnace_minecart", (new ItemMinecart(EntityMinecartAbstract.a.FURNACE)).c("minecartFurnace"));
        ...
        a(407, "tnt_minecart", (new ItemMinecart(EntityMinecartAbstract.a.TNT)).c("minecartTnt"));
        a(408, "hopper_minecart", (new ItemMinecart(EntityMinecartAbstract.a.HOPPER)).c("minecartHopper"));
        ...
        a(422, "command_block_minecart", (new ItemMinecart(EntityMinecartAbstract.a.COMMAND_BLOCK)).c("minecartCommandBlock").a((CreativeModeTab) null));
    ...
    public static enum a {
        ...
        private a(int i, int j, float f, float f1, int k) {
            this.f = i;
            this.g = j;
            this.h = f;
            this.i = f1;
        ...
        public Item f() {
            return this == Item.a.WOOD ? Item.getItemOf(Blocks.PLANKS) : (this == Item.a.STONE ? Item.getItemOf(Blocks.COBBLESTONE) : (this == Item.a.GOLD ? Items.GOLD_INGOT : (this == Item.a.IRON ? Items.IRON_INGOT : (this == Item.a.EMERALD ? Items.DIAMOND : null))));
        }
    }
}
