...
public class WorldGenBigTree extends WorldGenTreeAbstract {
    ...
    void a() {
        ...
        this.j.add(new WorldGenBigTree.a(this.m.up(k), j));
                ...
                for (int l = 0; l < i; ++l) {
                    ...
                    if (this.a(blockposition, blockposition1) == -1) {
                        ...
                        if (this.a(blockposition2, blockposition) == -1) {
                            this.j.add(new WorldGenBigTree.a(blockposition, blockposition2.getY()));
                        }
                    }
                }
            }
    ...
    void a(BlockPosition blockposition, BlockPosition blockposition1, Block block) {
        ...
        for (int j = 0; j <= i; ++j) {
            ...
            BlockLogAbstract.a blocklogabstract_a = this.b(blockposition, blockposition3);

            this.a(this.l, blockposition3, block.getBlockData().set(BlockLogAbstract.AXIS, blocklogabstract_a));
        }
    ...
    private BlockLogAbstract.a b(BlockPosition blockposition, BlockPosition blockposition1) {
        BlockLogAbstract.a blocklogabstract_a = BlockLogAbstract.a.Y;
        ...
        if (k > 0) {
            if (i == k) {
                blocklogabstract_a = BlockLogAbstract.a.X;
            } else if (j == k) {
                blocklogabstract_a = BlockLogAbstract.a.Z;
            }
        }

        return blocklogabstract_a;
    }
    ...
    void b() {
        ...
        while (iterator.hasNext()) {
            ...
            this.a((BlockPosition) worldgenbigtree_a);
        }
    ...
    void d() {
        ...
        while (iterator.hasNext()) {
            WorldGenBigTree.a worldgenbigtree_a = (WorldGenBigTree.a) iterator.next();
            int i = worldgenbigtree_a.q();
            BlockPosition blockposition = new BlockPosition(this.m.getX(), i, this.m.getZ());

            if (!blockposition.equals(worldgenbigtree_a) && this.c(i - this.m.getY())) {
                this.a(blockposition, (BlockPosition) worldgenbigtree_a, Blocks.LOG);
            }
        }
