...
public class WorldGenForestTree extends WorldGenTreeAbstract {
    ...
    private static final IBlockData a = Blocks.LOG2.getBlockData().set(BlockLog2.VARIANT, BlockWood.a.DARK_OAK);
    private static final IBlockData b = Blocks.LEAVES2.getBlockData().set(BlockLeaves2.VARIANT, BlockWood.a.DARK_OAK).set(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
        ...
        for (int i1 = 0; i1 <= i + 1; ++i1) {
            ...
            for (int j1 = -b0; j1 <= b0; ++j1) {
                for (int k1 = -b0; k1 <= b0; ++k1) {
                    if (!this.a(world.getType(blockposition_a.c(j + j1, k + i1, l + k1)).getBlock())) {
                        return false;
                    }
                }
            }
