...
public class DedicatedServer extends MinecraftServer implements IMinecraftServer {
    ...
    protected boolean init() throws IOException {
        Thread thread = new Thread("Server console handler") {
            public void run() {
                ...
                try {
                    ...
                    DedicatedServer.LOGGER.error("Exception handling console input", (Throwable) ioexception);
                }
        ...
        if (!this.p.a()) {
            ...
            int i = this.propertyManager.getInt("gamemode", WorldSettings.a.SURVIVAL.getId());
    ...
    public void setGamemode(WorldSettings.a worldsettings_a) {
        super.setGamemode(worldsettings_a);
        this.r = worldsettings_a;
    }
    ...
    public String a(WorldSettings.a worldsettings_a, boolean flag) {
        return "";
    }
