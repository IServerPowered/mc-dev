    ...
    public void e(float f, float f1) {
        ...
        if (i > 0) {
            ...
            if (block.getMaterial() != Material.AIR) {
                ...
                this.makeSound(block_b.getStepSound(), block_b.getVolume1() * 0.5F, block_b.getVolume2() * 0.75F);
            }
        }
    ...
    public int br() {
        ...
        for (int k = 0; k < j; ++k) {
            ...
            if (itemstack != null && itemstack.getItem() instanceof ItemArmor) {
                int l = ((ItemArmor) itemstack.getItem()).durability;
