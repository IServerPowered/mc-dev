...
public interface IChatBaseComponent extends Iterable<IChatBaseComponent> {
    ...
    public static class a implements JsonDeserializer<IChatBaseComponent>, JsonSerializer<IChatBaseComponent> {
        ...
        public static String a(IChatBaseComponent ichatbasecomponent) {
            return IChatBaseComponent.a.a.toJson((Object) ichatbasecomponent);
        }

        public static IChatBaseComponent a(String s) {
            return (IChatBaseComponent) IChatBaseComponent.a.a.fromJson(s, IChatBaseComponent.class);
        }
        ...
        static {
            ...
            gsonbuilder.registerTypeHierarchyAdapter(IChatBaseComponent.class, new IChatBaseComponent.a());
            gsonbuilder.registerTypeHierarchyAdapter(ChatModifier.class, new ChatModifier.a());
