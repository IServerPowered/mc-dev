...
public class PlayerInteractManager {
    ...
    private WorldSettings.a gamemode;
    private boolean d;
    ...
    public PlayerInteractManager(World world) {
        this.gamemode = WorldSettings.a.NOT_SET;
    ...
    public void setGameMode(WorldSettings.a worldsettings_a) {
        this.gamemode = worldsettings_a;
        worldsettings_a.a(this.player.abilities);
        this.player.updateAbilities();
        this.player.server.getPlayerList().sendAll(new PacketPlayOutPlayerInfo(PacketPlayOutPlayerInfo.a.UPDATE_GAME_MODE, new EntityPlayer[] { this.player}));
    }

    public WorldSettings.a getGameMode() {
    ...
    public void b(WorldSettings.a worldsettings_a) {
        if (this.gamemode == WorldSettings.a.NOT_SET) {
            this.gamemode = worldsettings_a;
        }
    ...
    public void a(BlockPosition blockposition, EnumDirection enumdirection) {
        if (this.isCreative()) {
            ...
            if (this.gamemode.c()) {
                if (this.gamemode == WorldSettings.a.SPECTATOR) {
                    return;
                }
