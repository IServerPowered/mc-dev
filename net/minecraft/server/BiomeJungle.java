...
public class BiomeJungle extends BiomeBase {
    ...
    private boolean aD;
    private static final IBlockData aE = Blocks.LOG.getBlockData().set(BlockLog1.VARIANT, BlockWood.a.JUNGLE);
    private static final IBlockData aF = Blocks.LEAVES.getBlockData().set(BlockLeaves1.VARIANT, BlockWood.a.JUNGLE).set(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    private static final IBlockData aG = Blocks.LEAVES.getBlockData().set(BlockLeaves1.VARIANT, BlockWood.a.OAK).set(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    public BiomeJungle(int i, boolean flag) {
        ...
        this.as.B = 4;
        if (!flag) {
            this.at.add(new BiomeBase.c(EntityOcelot.class, 2, 1, 1));
        }
    ...
    public WorldGenerator b(Random random) {
        return random.nextInt(4) == 0 ? new WorldGenGrass(BlockLongGrass.a.FERN) : new WorldGenGrass(BlockLongGrass.a.GRASS);
    }
