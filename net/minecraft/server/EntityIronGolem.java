...
public class EntityIronGolem extends EntityGolem {
    ...
    protected void E() {
        if (--this.b <= 0) {
            ...
            if (this.lookController == null) {
                ...
                this.a(blockposition, (int) ((float) this.lookController.b() * 0.6F));
            }
        }
    ...
    public void die(DamageSource damagesource) {
        if (!this.isPlayerCreated() && this.killer != null && this.lookController != null) {
            this.lookController.a(this.killer.getName(), -5);
        }
