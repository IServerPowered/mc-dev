...
public class EntitySpider extends EntityMonster {
    ...
    public EntitySpider(World world) {
        ...
        this.goalSelector.a(4, new EntitySpider.a(this, EntityHuman.class));
        this.goalSelector.a(4, new EntitySpider.a(this, EntityIronGolem.class));
        this.goalSelector.a(5, new PathfinderGoalRandomStroll(this, 0.8D));
        this.goalSelector.a(6, new PathfinderGoalLookAtPlayer(this, EntityHuman.class, 8.0F));
        this.goalSelector.a(6, new PathfinderGoalRandomLookaround(this));
        this.targetSelector.a(1, new PathfinderGoalHurtByTarget(this, false, new Class[0]));
        this.targetSelector.a(2, new EntitySpider.c(this, EntityHuman.class));
        this.targetSelector.a(3, new EntitySpider.c(this, EntityIronGolem.class));
    }
    ...
    public GroupDataEntity prepare(DifficultyDamageScaler difficultydamagescaler, GroupDataEntity groupdataentity) {
        ...
        if (object == null) {
            object = new EntitySpider.b();
            if (this.world.getDifficulty() == EnumDifficulty.HARD && this.world.random.nextFloat() < 0.1F * difficultydamagescaler.c()) {
                ((EntitySpider.b) object).a(this.world.random);
            }
        }

        if (object instanceof EntitySpider.b) {
            int i = ((EntitySpider.b) object).a;
    ...
    static class c<T extends EntityLiving> extends PathfinderGoalNearestAttackableTarget {

        public c(EntitySpider entityspider, Class<T> oclass) {
    ...
    static class a extends PathfinderGoalMeleeAttack {
        ...
        public a(EntitySpider entityspider, Class<? extends Entity> oclass) {
