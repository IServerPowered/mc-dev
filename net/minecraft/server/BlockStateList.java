...
public class BlockStateList {
    ...
    public BlockStateList(Block block, IBlockState... aiblockstate) {
        ...
        this.d = ImmutableList.copyOf((Object[]) aiblockstate);
        ...
        while (iterator.hasNext()) {
            ...
            BlockStateList.a blockstatelist_a = new BlockStateList.a(block, ImmutableMap.copyOf(map), null);

            linkedhashmap.put(map, blockstatelist_a);
            arraylist.add(blockstatelist_a);
        }

        iterator = arraylist.iterator();

        while (iterator.hasNext()) {
            BlockStateList.a blockstatelist_a1 = (BlockStateList.a) iterator.next();

            blockstatelist_a1.a((Map) linkedhashmap);
        }
    ...
    public String toString() {
        return Objects.toStringHelper((Object) this).add("block", Block.REGISTRY.c(this.c)).add("properties", Iterables.transform(this.d, BlockStateList.b)).toString();
    }

    static class a extends BlockDataAbstract {

        private final Block a;
        private final ImmutableMap<IBlockState, Comparable> b;
        private ImmutableTable<IBlockState, Comparable, IBlockData> c;

        private a(Block block, ImmutableMap<IBlockState, Comparable> immutablemap) {
            this.a = block;
            this.b = immutablemap;
        }
        ...
        public void a(Map<Map<IBlockState, Comparable>, BlockStateList.a> map) {
            if (this.c != null) {
        ...
        a(Block block, ImmutableMap immutablemap, Object object) {
