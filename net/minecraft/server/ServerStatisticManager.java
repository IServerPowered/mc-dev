...
public class ServerStatisticManager extends StatisticManager {
    ...
    public void a() {
        if (this.d.isFile()) {
            try {
                ...
                ServerStatisticManager.b.error("Couldn\'t read statistics file " + this.d, (Throwable) ioexception);
            } catch (JsonParseException jsonparseexception) {
                ServerStatisticManager.b.error("Couldn\'t parse statistics file " + this.d, (Throwable) jsonparseexception);
            }
        }
    ...
    public void b() {
        try {
            ...
            ServerStatisticManager.b.error("Couldn\'t save stats", (Throwable) ioexception);
        }
