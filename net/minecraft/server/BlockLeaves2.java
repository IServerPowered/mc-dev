...
public class BlockLeaves2 extends BlockLeaves {
    ...
    public BlockLeaves2() {
        this.j(this.blockStateList.getBlockData().set(BlockLeaves2.VARIANT, BlockWood.a.ACACIA).set(BlockLeaves2.CHECK_DECAY, Boolean.valueOf(true)).set(BlockLeaves2.DECAYABLE, Boolean.valueOf(true)));
    }

    protected void a(World world, BlockPosition blockposition, IBlockData iblockdata, int i) {
        if (iblockdata.get(BlockLeaves2.VARIANT) == BlockWood.a.DARK_OAK && world.random.nextInt(i) == 0) {
    ...
    public int getDropData(IBlockData iblockdata) {
        return ((BlockWood.a) iblockdata.get(BlockLeaves2.VARIANT)).a();
    }
    ...
    protected ItemStack i(IBlockData iblockdata) {
        return new ItemStack(Item.getItemOf(this), 1, ((BlockWood.a) iblockdata.get(BlockLeaves2.VARIANT)).a() - 4);
    }
    ...
    public int toLegacyData(IBlockData iblockdata) {
        byte b0 = 0;
        int i = b0 | ((BlockWood.a) iblockdata.get(BlockLeaves2.VARIANT)).a() - 4;
    ...
    public void a(World world, EntityHuman entityhuman, BlockPosition blockposition, IBlockData iblockdata, TileEntity tileentity) {
        if (!world.isClientSide && entityhuman.bZ() != null && entityhuman.bZ().getItem() == Items.SHEARS) {
            ...
            a(world, blockposition, new ItemStack(Item.getItemOf(this), 1, ((BlockWood.a) iblockdata.get(BlockLeaves2.VARIANT)).a() - 4));
        } else {
