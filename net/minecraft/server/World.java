...
public abstract class World implements IBlockAccess {
                ...
                while (k1-- >= 0) {
                    ...
                    if (!flag1 || block1.a(this, blockposition, iblockdata1) != null) {
                        if (block1.a(iblockdata1, flag)) {
                            ...
                            movingobjectposition1 = new MovingObjectPosition(MovingObjectPosition.a.MISS, vec3d, enumdirection, blockposition);
                        }
                    }
                }
    ...
    public List<AxisAlignedBB> getCubes(Entity entity, AxisAlignedBB axisalignedbb) {
        ...
        for (int k1 = i; k1 < j; ++k1) {
            for (int l1 = i1; l1 < j1; ++l1) {
                if (this.isLoaded(blockposition_a.c(k1, 64, l1))) {
                    for (int i2 = k - 1; i2 < l; ++i2) {
                        blockposition_a.c(k1, i2, l1);
                        if (flag && flag1) {
                            entity.h(false);
                        } else if (!flag && !flag1) {
                            entity.h(true);
                        ...
                        if (worldborder.a((BlockPosition) blockposition_a) || !flag1) {
                            iblockdata1 = this.getType(blockposition_a);
                        }

                        iblockdata1.getBlock().a(this, blockposition_a, iblockdata1, axisalignedbb, arraylist, entity);
                    }
                }
            }
        }
                ...
                if (this.isLoaded(blockposition_a.c(k1, 64, l1))) {
                    for (int i2 = k - 1; i2 < l; ++i2) {
                        ...
                        if (k1 >= -30000000 && k1 < 30000000 && l1 >= -30000000 && l1 < 30000000) {
                            iblockdata = this.getType(blockposition_a);
                        } else {
                            iblockdata = Blocks.BEDROCK.getBlockData();
                        }

                        iblockdata.getBlock().a(this, blockposition_a, iblockdata, axisalignedbb, arraylist, (Entity) null);
                    }
                }
            }
        }
        ...
        for (int k1 = i; k1 <= j; ++k1) {
            for (int l1 = k; l1 <= l; ++l1) {
                for (int i2 = i1; i2 <= j1; ++i2) {
                    Block block = this.getType(blockposition_a.c(k1, l1, i2)).getBlock();
            ...
            for (int k1 = i; k1 < j; ++k1) {
                for (int l1 = k; l1 < l; ++l1) {
                    for (int i2 = i1; i2 < j1; ++i2) {
                        ...
                        IBlockData iblockdata = this.getType(blockposition_a);
                        Block block = iblockdata.getBlock();
                        ...
                        if (block.getMaterial() == material) {
                            ...
                            if ((double) l >= d0) {
                                flag = true;
                                vec3d = block.a(this, blockposition_a, entity, vec3d);
                            }
                        }
                    }
                }
    ...
    public boolean a(AxisAlignedBB axisalignedbb, Material material) {
        ...
        for (int k1 = i; k1 < j; ++k1) {
            for (int l1 = k; l1 < l; ++l1) {
                for (int i2 = i1; i2 < j1; ++i2) {
                    if (this.getType(blockposition_a.c(k1, l1, i2)).getBlock().getMaterial() == material) {
                        return true;
                    }
                }
            }
    ...
    public boolean b(AxisAlignedBB axisalignedbb, Material material) {
        ...
        for (int k1 = i; k1 < j; ++k1) {
            for (int l1 = k; l1 < l; ++l1) {
                for (int i2 = i1; i2 < j1; ++i2) {
                    IBlockData iblockdata = this.getType(blockposition_a.c(k1, l1, i2));
                    Block block = iblockdata.getBlock();
    ...
    public TileEntity getTileEntity(BlockPosition blockposition) {
        if (!this.isValidLocation(blockposition)) {
            ...
            if (tileentity == null) {
                tileentity = this.getChunkAtWorldCoords(blockposition).a(blockposition, Chunk.a.IMMEDIATE);
            }
    ...
    public static boolean a(IBlockAccess iblockaccess, BlockPosition blockposition) {
        ...
        return block.getMaterial().k() && block.d() ? true : (block instanceof BlockStairs ? iblockdata.get(BlockStairs.HALF) == BlockStairs.a.TOP : (block instanceof BlockStepAbstract ? iblockdata.get(BlockStepAbstract.HALF) == BlockStepAbstract.a.TOP : (block instanceof BlockHopper ? true : (block instanceof BlockSnow ? ((Integer) iblockdata.get(BlockSnow.LAYERS)).intValue() == 7 : false))));
    }
                        ...
                        if (l3 > 0) {
                            ...
                            if (i3 + j3 + k3 < 17) {
                                ...
                                for (int j4 = 0; j4 < i4; ++j4) {
                                    ...
                                    blockposition_a.c(k4, l4, i5);
                                    int j5 = Math.max(1, this.getType(blockposition_a).getBlock().p());

                                    l2 = this.b(enumskyblock, (BlockPosition) blockposition_a);
