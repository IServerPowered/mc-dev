...
public class BlockDoor extends Block {
    ...
    public static final BlockStateEnum<BlockDoor.b> HINGE = BlockStateEnum.of("hinge", BlockDoor.b.class);
    public static final BlockStateBoolean POWERED = BlockStateBoolean.of("powered");
    public static final BlockStateEnum<BlockDoor.a> HALF = BlockStateEnum.of("half", BlockDoor.a.class);

    protected BlockDoor(Material material) {
        super(material);
        this.j(this.blockStateList.getBlockData().set(BlockDoor.FACING, EnumDirection.NORTH).set(BlockDoor.OPEN, Boolean.valueOf(false)).set(BlockDoor.HINGE, BlockDoor.b.LEFT).set(BlockDoor.POWERED, Boolean.valueOf(false)).set(BlockDoor.HALF, BlockDoor.a.LOWER));
    }
    ...
    public boolean interact(World world, BlockPosition blockposition, IBlockData iblockdata, EntityHuman entityhuman, EnumDirection enumdirection, float f, float f1, float f2) {
        if (this.material == Material.ORE) {
            ...
            BlockPosition blockposition1 = iblockdata.get(BlockDoor.HALF) == BlockDoor.a.LOWER ? blockposition : blockposition.down();
    ...
    public void doPhysics(World world, BlockPosition blockposition, IBlockData iblockdata, Block block) {
        if (iblockdata.get(BlockDoor.HALF) == BlockDoor.a.UPPER) {
    ...
    public Item getDropType(IBlockData iblockdata, Random random, int i) {
        return iblockdata.get(BlockDoor.HALF) == BlockDoor.a.UPPER ? null : this.l();
    }
    ...
    public void a(World world, BlockPosition blockposition, IBlockData iblockdata, EntityHuman entityhuman) {
        ...
        if (entityhuman.abilities.canInstantlyBuild && iblockdata.get(BlockDoor.HALF) == BlockDoor.a.UPPER && world.getType(blockposition1).getBlock() == this) {
    ...
    public IBlockData updateState(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition) {
        ...
        if (iblockdata.get(BlockDoor.HALF) == BlockDoor.a.LOWER) {
    ...
    public IBlockData fromLegacyData(int i) {
        return (i & 8) > 0 ? this.getBlockData().set(BlockDoor.HALF, BlockDoor.a.UPPER).set(BlockDoor.HINGE, (i & 1) > 0 ? BlockDoor.b.RIGHT : BlockDoor.b.LEFT).set(BlockDoor.POWERED, Boolean.valueOf((i & 2) > 0)) : this.getBlockData().set(BlockDoor.HALF, BlockDoor.a.LOWER).set(BlockDoor.FACING, EnumDirection.fromType2(i & 3).f()).set(BlockDoor.OPEN, Boolean.valueOf((i & 4) > 0));
    }
    ...
    public int toLegacyData(IBlockData iblockdata) {
        ...
        if (iblockdata.get(BlockDoor.HALF) == BlockDoor.a.UPPER) {
            i = b0 | 8;
            if (iblockdata.get(BlockDoor.HINGE) == BlockDoor.b.RIGHT) {
                i |= 1;
            }
    ...
    public static enum b implements INamable {
        ...
        public String getName() {
            return this == BlockDoor.b.LEFT ? "left" : "right";
        }
    }
    ...
    public static enum a implements INamable {
        ...
        public String getName() {
            return this == BlockDoor.a.UPPER ? "upper" : "lower";
        }
    }
}
