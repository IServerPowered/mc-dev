...
public class BlockBanner extends BlockContainer {
    ...
    public static class a extends BlockBanner {

        public a() {
            this.j(this.blockStateList.getBlockData().set(BlockBanner.a.ROTATION, Integer.valueOf(0)));
        }
        ...
        public IBlockData fromLegacyData(int i) {
            return this.getBlockData().set(BlockBanner.a.ROTATION, Integer.valueOf(i));
        }

        public int toLegacyData(IBlockData iblockdata) {
            return ((Integer) iblockdata.get(BlockBanner.a.ROTATION)).intValue();
        }

        protected BlockStateList getStateList() {
            return new BlockStateList(this, new IBlockState[] { BlockBanner.a.ROTATION});
        }
    }

    public static class b extends BlockBanner {

        public b() {
            this.j(this.blockStateList.getBlockData().set(BlockBanner.b.FACING, EnumDirection.NORTH));
        }

        public void updateShape(IBlockAccess iblockaccess, BlockPosition blockposition) {
            EnumDirection enumdirection = (EnumDirection) iblockaccess.getType(blockposition).get(BlockBanner.b.FACING);
            float f = 0.0F;
            float f1 = 0.78125F;
            float f2 = 0.0F;
            float f3 = 1.0F;
        ...
        public void doPhysics(World world, BlockPosition blockposition, IBlockData iblockdata, Block block) {
            EnumDirection enumdirection = (EnumDirection) iblockdata.get(BlockBanner.b.FACING);
        ...
        public IBlockData fromLegacyData(int i) {
            ...
            return this.getBlockData().set(BlockBanner.b.FACING, enumdirection);
        }

        public int toLegacyData(IBlockData iblockdata) {
            return ((EnumDirection) iblockdata.get(BlockBanner.b.FACING)).a();
        }

        protected BlockStateList getStateList() {
            return new BlockStateList(this, new IBlockState[] { BlockBanner.b.FACING});
        }
    }
}
