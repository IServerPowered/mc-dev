...
public abstract class Entity implements ICommandListener {
    ...
    protected void a(BlockPosition blockposition, Block block) {
        ...
        if (this.world.getType(blockposition.up()).getBlock() == Blocks.SNOW_LAYER) {
            ...
            this.makeSound(block_b.getStepSound(), block_b.getVolume1() * 0.15F, block_b.getVolume2());
    ...
    public boolean inBlock() {
        if (this.noclip) {
            ...
            BlockPosition.a blockposition_a = new BlockPosition.a(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE);
            ...
            for (int i = 0; i < 8; ++i) {
                ...
                if (blockposition_a.getX() != k || blockposition_a.getY() != j || blockposition_a.getZ() != l) {
                    blockposition_a.c(k, j, l);
                    if (this.world.getType(blockposition_a).getBlock().w()) {
                        return true;
                    }
                }
            }
    ...
    public void d(BlockPosition blockposition) {
        if (this.portalCooldown > 0) {
            ...
            if (!this.world.isClientSide && !blockposition.equals(this.an)) {
                ...
                ShapeDetector.b shapedetector_b = Blocks.PORTAL.f(this.world, blockposition);
                double d0 = shapedetector_b.b().k() == EnumDirection.a.X ? (double) shapedetector_b.a().getZ() : (double) shapedetector_b.a().getX();
                double d1 = shapedetector_b.b().k() == EnumDirection.a.X ? this.locZ : this.locX;

                d1 = Math.abs(MathHelper.c(d1 - (double) (shapedetector_b.b().e().c() == EnumDirection.b.NEGATIVE ? 1 : 0), d0, d0 - (double) shapedetector_b.d()));
                double d2 = MathHelper.c(this.locY - 1.0D, (double) shapedetector_b.a().getY(), (double) (shapedetector_b.a().getY() - shapedetector_b.e()));

                this.ao = new Vec3D(d1, d2, 0.0D);
                this.ap = shapedetector_b.b();
            }
    ...
    protected ChatHoverable aQ() {
        ...
        return new ChatHoverable(ChatHoverable.a.SHOW_ENTITY, new ChatComponentText(nbttagcompound.toString()));
    }
    ...
    public void a(CommandObjectiveExecutor.a commandobjectiveexecutor_a, int i) {
        this.au.a(this, commandobjectiveexecutor_a, i);
    }
