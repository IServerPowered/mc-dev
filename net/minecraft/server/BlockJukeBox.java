...
public class BlockJukeBox extends BlockContainer {
    ...
    public void a(World world, BlockPosition blockposition, IBlockData iblockdata, ItemStack itemstack) {
        if (!world.isClientSide) {
            ...
            if (tileentity instanceof BlockJukeBox.a) {
                ((BlockJukeBox.a) tileentity).setRecord(new ItemStack(itemstack.getItem(), 1, itemstack.getData()));
    ...
    private void dropRecord(World world, BlockPosition blockposition, IBlockData iblockdata) {
        if (!world.isClientSide) {
            ...
            if (tileentity instanceof BlockJukeBox.a) {
                BlockJukeBox.a blockjukebox_a = (BlockJukeBox.a) tileentity;
                ItemStack itemstack = blockjukebox_a.getRecord();

                if (itemstack != null) {
                    world.triggerEffect(1005, blockposition, 0);
                    world.a(blockposition, (String) null);
                    blockjukebox_a.setRecord((ItemStack) null);
                    float f = 0.7F;
    ...
    public int l(World world, BlockPosition blockposition) {
        ...
        if (tileentity instanceof BlockJukeBox.a) {
            ItemStack itemstack = ((BlockJukeBox.a) tileentity).getRecord();
    ...
    public static class a extends TileEntity {
