...
public class EntitySilverfish extends EntityMonster {
    ...
    private EntitySilverfish.b a;

    public EntitySilverfish(World world) {
        super(world);
        this.setSize(0.4F, 0.3F);
        this.goalSelector.a(1, new PathfinderGoalFloat(this));
        this.goalSelector.a(3, this.a = new EntitySilverfish.b(this));
        this.goalSelector.a(4, new PathfinderGoalMeleeAttack(this, EntityHuman.class, 1.0D, false));
        this.goalSelector.a(5, new EntitySilverfish.a(this));
    ...
    static class a extends PathfinderGoalRandomStroll {

        private final EntitySilverfish silverfish;
        private EnumDirection b;
        private boolean c;

        public a(EntitySilverfish entitysilverfish) {
        ...
        public void c() {
            if (!this.c) {
                ...
                if (BlockMonsterEggs.d(iblockdata)) {
                    world.setTypeAndData(blockposition, Blocks.MONSTER_EGG.getBlockData().set(BlockMonsterEggs.VARIANT, BlockMonsterEggs.a.a(iblockdata)), 3);
                    this.silverfish.y();
                    this.silverfish.die();
                }
    ...
    static class b extends PathfinderGoal {
        ...
        public b(EntitySilverfish entitysilverfish) {
            this.silverfish = entitysilverfish;
        }
                        ...
                        for (int k = 0; k <= 10 && k >= -10; k = k <= 0 ? 1 - k : 0 - k) {
                            ...
                            if (iblockdata.getBlock() == Blocks.MONSTER_EGG) {
                                if (world.getGameRules().getBoolean("mobGriefing")) {
                                    ...
                                    world.setTypeAndData(blockposition1, ((BlockMonsterEggs.a) iblockdata.get(BlockMonsterEggs.VARIANT)).d(), 3);
                                }
