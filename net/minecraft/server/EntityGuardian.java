...
public class EntityGuardian extends EntityMonster {
    ...
    public EntityGuardian(World world) {
        ...
        this.goalSelector.a(4, new EntityGuardian.a(this));
        ...
        this.targetSelector.a(1, new PathfinderGoalNearestAttackableTarget(this, EntityLiving.class, 10, true, false, new EntityGuardian.b(this)));
        this.moveController = new EntityGuardian.c(this);
    ...
    protected void dropDeathLoot(boolean flag, int i) {
        ...
        if (this.random.nextInt(3 + i) > 1) {
            this.a(new ItemStack(Items.FISH, 1, ItemFish.a.COD.a()), 1.0F);
    ...
    static class c extends ControllerMove {

        private EntityGuardian g;

        public c(EntityGuardian entityguardian) {
    ...
    static class a extends PathfinderGoal {
        ...
        public a(EntityGuardian entityguardian) {
    ...
    static class b implements Predicate<EntityLiving> {

        private EntityGuardian a;

        public b(EntityGuardian entityguardian) {
            this.a = entityguardian;
        }
