...
public abstract class EntityInsentient extends EntityLiving {
    ...
    protected ControllerJump effects;
    ...
    public EntityInsentient(World world) {
        ...
        this.effects = new ControllerJump(this);
        ...
        if (i > -1) {
            ...
            if (itemstack1 != null) {
                if (i == 0) {
                    ...
                    if (itemarmor.durability == itemarmor1.durability) {
                        flag = itemstack.getData() > itemstack1.getData() || itemstack.hasTag() && !itemstack1.hasTag();
                    } else {
                        flag = itemarmor.durability > itemarmor1.durability;
                    }
                } else {
                    flag = false;
                }
