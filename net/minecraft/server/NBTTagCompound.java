...
public class NBTTagCompound extends NBTBase {
    ...
    public byte getByte(String s) {
        try {
            return !this.hasKeyOfType(s, 99) ? 0 : ((NBTBase.a) this.map.get(s)).f();
    ...
    public short getShort(String s) {
        try {
            return !this.hasKeyOfType(s, 99) ? 0 : ((NBTBase.a) this.map.get(s)).e();
        } catch (ClassCastException classcastexception) {
            return (short) 0;
        }
    }
    ...
    public int getInt(String s) {
        try {
            return !this.hasKeyOfType(s, 99) ? 0 : ((NBTBase.a) this.map.get(s)).d();
        } catch (ClassCastException classcastexception) {
            return 0;
        }
    }
    ...
    public long getLong(String s) {
        try {
            return !this.hasKeyOfType(s, 99) ? 0L : ((NBTBase.a) this.map.get(s)).c();
        } catch (ClassCastException classcastexception) {
            return 0L;
        }
    }
    ...
    public float getFloat(String s) {
        try {
            return !this.hasKeyOfType(s, 99) ? 0.0F : ((NBTBase.a) this.map.get(s)).h();
        } catch (ClassCastException classcastexception) {
            return 0.0F;
        }
    }
    ...
    public double getDouble(String s) {
        try {
            return !this.hasKeyOfType(s, 99) ? 0.0D : ((NBTBase.a) this.map.get(s)).g();
        } catch (ClassCastException classcastexception) {
            return 0.0D;
        }
    }
