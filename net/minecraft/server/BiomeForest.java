...
public class BiomeForest extends BiomeBase {
    ...
    public BiomeForest(int i, int j) {
        ...
        if (this.aG == 0) {
            this.au.add(new BiomeBase.c(EntityWolf.class, 5, 4, 4));
        }
    ...
    public BlockFlowers.a a(Random random, BlockPosition blockposition) {
        if (this.aG == 1) {
            ...
            BlockFlowers.a blockflowers_a = BlockFlowers.a.values()[(int) (d0 * (double) BlockFlowers.a.values().length)];

            return blockflowers_a == BlockFlowers.a.BLUE_ORCHID ? BlockFlowers.a.POPPY : blockflowers_a;
        } else {
    ...
    public void a(World world, Random random, BlockPosition blockposition) {
        ...
        while (j < i) {
            k = random.nextInt(3);
            if (k == 0) {
                BiomeForest.ag.a(BlockTallPlant.b.SYRINGA);
            } else if (k == 1) {
                BiomeForest.ag.a(BlockTallPlant.b.ROSE);
            } else if (k == 2) {
                BiomeForest.ag.a(BlockTallPlant.b.PAEONIA);
            }
    ...
    protected BiomeBase d(final int i) {
        if (this.id == BiomeBase.FOREST.id) {
            ...
            biomeforest.a(new BiomeBase.a(this.an, this.ao + 0.2F));
