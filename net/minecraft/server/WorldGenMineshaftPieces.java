...
public class WorldGenMineshaftPieces {
    ...
    public static void a() {
        WorldGenFactory.a(WorldGenMineshaftPieces.a.class, "MSCorridor");
        WorldGenFactory.a(WorldGenMineshaftPieces.b.class, "MSCrossing");
        WorldGenFactory.a(WorldGenMineshaftPieces.c.class, "MSRoom");
        WorldGenFactory.a(WorldGenMineshaftPieces.d.class, "MSStairs");
    }
    ...
    private static StructurePiece a(List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        ...
        if (i1 >= 80) {
            structureboundingbox = WorldGenMineshaftPieces.b.a(list, random, i, j, k, enumdirection);
            if (structureboundingbox != null) {
                return new WorldGenMineshaftPieces.b(l, random, structureboundingbox, enumdirection);
            }
        } else if (i1 >= 70) {
            structureboundingbox = WorldGenMineshaftPieces.d.a(list, random, i, j, k, enumdirection);
            if (structureboundingbox != null) {
                return new WorldGenMineshaftPieces.d(l, random, structureboundingbox, enumdirection);
            }
        } else {
            structureboundingbox = WorldGenMineshaftPieces.a.a(list, random, i, j, k, enumdirection);
            if (structureboundingbox != null) {
                return new WorldGenMineshaftPieces.a(l, random, structureboundingbox, enumdirection);
            }
        }
    ...
    public static class d extends StructurePiece {
    ...
    public static class b extends StructurePiece {
    ...
    public static class c extends StructurePiece {

        private List<StructureBoundingBox> a = Lists.newLinkedList();

        public c() {}

        public c(int i, Random random, int j, int k) {
            super(i);
