...
public class IteratorUtils {
    ...
    public static <T> Iterable<T[]> a(Class<T> oclass, Iterable<? extends Iterable<? extends T>> iterable) {
        return new IteratorUtils.b(oclass, (Iterable[]) b(Iterable.class, iterable), (IteratorUtils.SyntheticClass_1) null);
    }
    ...
    private static <T> Iterable<List<T>> b(Iterable<Object[]> iterable) {
        return Iterables.transform(iterable, new IteratorUtils.a((IteratorUtils.SyntheticClass_1) null));
    }
    ...
    static class b<T> implements Iterable<T[]> {
        ...
        private b(Class<T> oclass, Iterable<? extends T>[] aiterable) {
            this.a = oclass;
            this.b = aiterable;
        }

        public Iterator<T[]> iterator() {
            return (Iterator) (this.b.length <= 0 ? Collections.singletonList((Object[]) IteratorUtils.b(this.a, 0)).iterator() : new IteratorUtils.b.a(this.a, this.b, (IteratorUtils.SyntheticClass_1) null));
        }

        b(Class oclass, Iterable[] aiterable, IteratorUtils.SyntheticClass_1 iteratorutils_syntheticclass_1) {
        ...
        static class a<T> extends UnmodifiableIterator<T[]> {
            ...
            private a(Class<T> oclass, Iterable<? extends T>[] aiterable) {
                this.a = -2;
                this.b = aiterable;
            ...
            a(Class oclass, Iterable[] aiterable, IteratorUtils.SyntheticClass_1 iteratorutils_syntheticclass_1) {
                this(oclass, aiterable);
            }
        }
    }
    ...
    static class a<T> implements Function<Object[], List<T>> {
        ...
        a(IteratorUtils.SyntheticClass_1 iteratorutils_syntheticclass_1) {
            this();
        }
    }
}
