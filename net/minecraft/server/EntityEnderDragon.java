...
public class EntityEnderDragon extends EntityInsentient implements IComplex, IMonster {
    ...
    public void recalcPosition() {
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            if (++this.equipment == this.bi.length) {
                this.equipment = 0;
            }

            this.bi[this.equipment][0] = (double) this.yaw;
            this.bi[this.equipment][1] = this.locY;
            double d0;
            double d1;
            double d2;
            double d3;
            ...
            if (this.world.isStatic) {
                ...
                if (this.by != null) {
                    this.lookController = this.by.locX;
                    this.goalTarget = this.by.locZ;
                    ...
                    this.entityCount = this.by.getBoundingBox().b + d4;
                } else {
            ...
            if (!this.world.isStatic) {
                this.bv = this.b(this.persistent.getBoundingBox()) | this.b(this.bm.getBoundingBox());
            }
