...
public class WorldGenAcaciaTree extends WorldGenTreeAbstract {
    ...
    private static final IBlockData a = Blocks.LOG2.getBlockData().set(BlockLog2.VARIANT, BlockWood.a.ACACIA);
    private static final IBlockData b = Blocks.LEAVES2.getBlockData().set(BlockLeaves2.VARIANT, BlockWood.a.ACACIA).set(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
        ...
        if (blockposition.getY() >= 1 && blockposition.getY() + i + 1 <= 256) {
            ...
            if (!flag) {
                ...
                if ((block == Blocks.GRASS || block == Blocks.DIRT) && blockposition.getY() < 256 - i - 1) {
                    ...
                    EnumDirection enumdirection1 = EnumDirection.c.HORIZONTAL.a(random);
