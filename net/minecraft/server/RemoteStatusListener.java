...
public class RemoteStatusListener extends RemoteConnectionThread {
    ...
    private String r;
    private String s;
    private Map<SocketAddress, RemoteStatusListener.a> t;
    private long u;
    ...
    private byte[] a(SocketAddress socketaddress) {
        return ((RemoteStatusListener.a) this.t.get(socketaddress)).c();
    }
    ...
    private Boolean c(DatagramPacket datagrampacket) {
        ...
        if (!this.t.containsKey(socketaddress)) {
            ...
            return ((RemoteStatusListener.a) this.t.get(socketaddress)).a() != StatusChallengeUtils.c(abyte, 7, datagrampacket.getLength()) ? Boolean.valueOf(false) : Boolean.valueOf(true);
        }
    }

    private void d(DatagramPacket datagrampacket) throws IOException {
        RemoteStatusListener.a remotestatuslistener_a = new RemoteStatusListener.a(datagrampacket);

        this.t.put(datagrampacket.getSocketAddress(), remotestatuslistener_a);
        this.a(remotestatuslistener_a.b(), datagrampacket);
    }
        ...
        if (this.a) {
            ...
            if (i >= this.h + 30000L) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (((RemoteStatusListener.a) entry.getValue()).a(i).booleanValue()) {
                        iterator.remove();
                    }
                }
